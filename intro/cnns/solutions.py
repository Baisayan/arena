...
def get_mnist(trainset_size: int = 10_000, testset_size: int = 1_000) -> tuple[Subset, Subset]:
    ...
    mnist_trainset = datasets.MNIST(main_dir / "data", train=True, download=True, transform=MNIST_TRANSFORM)
    mnist_testset = datasets.MNIST(main_dir / "data", train=False, download=True, transform=MNIST_TRANSFORM)
